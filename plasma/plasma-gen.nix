{
  programs.plasma = {
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."72d88335-676e-458d-802a-84cde8ff3c2c".value = "Default";
      "kactivitymanagerdrc"."main"."currentActivity".value = "72d88335-676e-458d-802a-84cde8ff3c2c";
      ...
      "kdeglobals"."KScreen"."ScreenScaleFactors".value = "eDP-2=1.5;DP-2=1.5;DP-3=1.5;DP-4=1.5;DP-5=1.5;DP-6=1.5;DP-7=1.5;DP-8=1.5;DP-9=1.5;eDP-1-1=1.5;DP-1-1=1.5;HDMI-1-1=1.5;";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid".value = "{aaac5140-c9fa-49d2-8a32-64c0ddcda4d0}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid".value = "{3f2388cf-f869-49e9-87f7-ba20c9ff161c}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid".value = "{f190e74f-6a66-42f9-b443-3966e8c6e457}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid".value = "{dbf4b579-96d3-4f4c-b680-a38d9e8eb913}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid".value = "{e4370cfc-03db-44df-adb7-5a0945ad2308}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid".value = "{26541643-e670-434b-bf88-5d9faeb165e5}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid".value = "{cc02ffcb-a700-4b60-9ad9-233a74b308a3}";
      ...
      "kwinrc"."Desktops"."Id_3".value = "40710298-f768-4f78-9610-096887587469";
      "kwinrc"."Desktops"."Id_4".value = "106ef41b-702d-4cb0-8ac8-256460f69f88";
