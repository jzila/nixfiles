{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-72d88335-676e-458d-802a-84cde8ff3c2c" = [ ];
      ...
      "kwin"."ShowDesktopGrid" = "Meta+Ctrl+K";
      "kwin"."Suspend Compositing" = "Alt+Shift+F12";
      "kwin"."Switch One Desktop Down" = "Meta+Ctrl+Down";
      "kwin"."Switch One Desktop Up" = "Meta+Ctrl+Up";
      "kwin"."Switch One Desktop to the Left" = ["" "Meta+Ctrl+Left" "Meta+Ctrl+H"];
      ...
      "kwin"."Window One Desktop to the Left" = ["" "Meta+Ctrl+Shift+Left" "Meta+Ctrl+Shift+H"];
      "kwin"."Window One Desktop to the Right" = ["" "Meta+Ctrl+Shift+Right" "Meta+Ctrl+Shift+L"];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."72d88335-676e-458d-802a-84cde8ff3c2c" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "72d88335-676e-458d-802a-84cde8ff3c2c";
      ...
      "kdeglobals"."KScreen"."ScreenScaleFactors" = "eDP-2=1.5;DP-2=1.5;DP-3=1.5;DP-4=1.5;DP-5=1.5;DP-6=1.5;DP-7=1.5;DP-8=1.5;DP-9=1.5;eDP-1-1=1.5;DP-1-1=1.5;HDMI-1-1=1.5;";
      ...
      "kglobalshortcutsrc"."alacritty.desktop"."_k_friendly_name" = "alacritty --command=zsh";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{aaac5140-c9fa-49d2-8a32-64c0ddcda4d0}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{3f2388cf-f869-49e9-87f7-ba20c9ff161c}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{f190e74f-6a66-42f9-b443-3966e8c6e457}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{dbf4b579-96d3-4f4c-b680-a38d9e8eb913}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{e4370cfc-03db-44df-adb7-5a0945ad2308}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{26541643-e670-434b-bf88-5d9faeb165e5}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{cc02ffcb-a700-4b60-9ad9-233a74b308a3}";
      ...
      "kwinrc"."Desktops"."Id_1" = "21431d7b-643a-4012-b3c2-19188db0bd5b";
      "kwinrc"."Desktops"."Id_2" = "60475ec7-fc04-4ad0-b288-23ae728705b7";
      "kwinrc"."Desktops"."Id_3" = "40710298-f768-4f78-9610-096887587469";
      "kwinrc"."Desktops"."Id_4" = "106ef41b-702d-4cb0-8ac8-256460f69f88";
      "kwinrc"."Desktops"."Number" = 4;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Effect-blur"."NoiseStrength" = 0;
      "kwinrc"."Plugins"."blurEnabled" = true;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/2f8449bd-7f98-5a0a-91cb-6534c92c8847"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/5f6a84cd-6e21-5fdd-9aa0-bfbda6aee800"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/600c622c-e89e-5d5e-b4fa-d8a445bcf9bc"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/993302cd-6261-5ff9-91ad-061b3d93c33e"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/a72d8f14-771b-5f6f-b985-72b8b9eeabdb"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/ba52937e-14bc-5d61-b746-7c20280c2308"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/d353be47-2d49-5c7a-9b0c-2a2b95dec5d3"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/de0db51d-395a-50b2-95f3-a3d432bb4038"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
